...
- Choix de numérisation → choix historiographiques
- Ordre de traitement : par section (politique, économique…) → recherche et événements (centenaire)
- OCR multilingue sur des documents des années 1920–1940
- Métadonnées : standardisation *a posteriori* d'un travail entamé depuis des années
